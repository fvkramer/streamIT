...
u12 = User.create!(username: 'AnimaTV', password: 'tokyoghoul', description: 'Best cinematic animatic hipnomatic animations of past, present, future, forever.', category: 'Film and Animation') #12
u13 = User.create!(username: 'Let\'s Learn!', password: 'education', description: 'Free educational and learning videos. Subscribe for New Content Every Week!', category: 'Education') #13
...
seed_vid_1 = Video.create!(title: "Got Castles", description: "Animated musical of Castle Kid Cartoon. Singing, Dancing, Birds, and Birdhouses", category: 'Film and Animation', channel_id: u12.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/animations/got_castles.mp4
...
seed_vid_2 = Video.create!(title: "Popeye For President", description: "Not even Chuck Norris can stop PopEye from the Presidency", category: 'Film and Animation', channel_id: u12.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/animations/popeye_president.mp4
...
seed_vid_3 = Video.create!(title: "Popeye Just Needs Some Sleep", description: "Can't a man just get some sleep?", category: 'Film and Animation', channel_id: u12.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/animations/shuteye_popeye.mp4
...
seed_vid_4 = Video.create!(title: "Sintel", description: "An Adventurer's Tail", category: 'Film and Animation', channel_id: u12.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/animations/sintel_blender.mp4
...
seed_vid_5 = Video.create!(title: "The Three Stooges Find a Pet", description: "Three Stooges find themselves in a pickle. Stooginess ensues.", category: 'Film and Animation', channel_id: u12.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/animations/three_stooges.mp4
...
seed_vid_6 = Video.create!(title: "Chemistry - The Avogadro Mole", description: "6.023 * 10^23 IS CHEMISTRY" , category: 'Education', channel_id: u13.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/education/avogadro_mole.mp4
...
seed_vid_7 = Video.create!(title: "The Structure of The Banking System", description: "Loan, Interest Rates, Inflation, And The Flow of Money Through Corporate and Governmental Structures", category: 'Education', channel_id: u13.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/education/banking.mp4
...
seed_vid_9 = Video.create!(title: "Blue Forehead Brain Teaser", description: "If Tricks are For Kids and Teasers are For Measels, then Whose Forehead Was Blue in this Brain Teaser?", category: 'Education', channel_id: u13.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/education/brain_teaser.mp4
...
seed_vid_10 = Video.create!(title: "Midwestern Fall Orange Glaze", description: "Gentle calm fall delights. Maple leaves in orange tint. ", category: 'Nature and Camping', channel_id: u14.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/environment/fall_leaves_orange.mp4
...
seed_vid_11 = Video.create!(title: "Red Maple Leaves", description: "Red Red Red. Fall beckons while nature's flames reckon", category: 'Nature and Camping', channel_id: u14.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/environment/fall_leaves_red.mp4
...
seed_vid_12 = Video.create!(title: "Infinity View - Space Asteroids", description: "Recursion Recursion Recursion Recursion Recursion Recursion Recursion Recursion Recursion Recursion Recursion Recursion Recursion ", category: 'Nature and Camping', channel_id: u14.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/environment/space_asteroids.mp4
...
seed_vid_13 = Video.create!(title: "Rural City Storm", description: "A storm hit the rural outskirts of Iowa. Clouds darkened. Rain intensified. The wind hit speeds of 90 mph and and sound whisteled through our ears.", category: 'Nature and Camping', channel_id: u14.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/environment/stormy_clouds.mp4
...
seed_vid_14 = Video.create!(title: "Ocean Waves Crashing Against The Cliffs", description: "Off the coast of Sardinia the waves hit upon the jagged cliffs", category: 'Nature and Camping', channel_id: u14.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/environment/waves_crashing_ocean.mp4
...
seed_vid_15 = Video.create!(title: "Wind Turbines in the Open Fields", description: "Alternative Energy - Wind Turbines Driving Down Oil Demand", category: 'Nature and Camping', channel_id: u14.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/environment/wind_turbines.mp4
...
seed_vid_16 = Video.create!(title: "Two Boys and One Pool", description: "The Most Satisfying StreamIt Video To Date", category: 'Entertainment', channel_id: u15.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/funny/two_boys_one_pool.mp4
...
seed_vid_17 = Video.create!(title: "Chrono Trigger Speed Run Sub 7 Minutes!", description: "Sub 7 Minute Chrono Speed Run! This man is insane!", category: 'Gaming', channel_id: u16.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/game_speed_runs/chrono_trigger.mp4
...
seed_vid_18 = Video.create!(title: "Sub 10 Minute Zelda Speed Run", description: "Link came. Link saw. Link conquered.", category: 'Gaming', channel_id: u16.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/game_speed_runs/zelda.mp4
...
seed_vid_19 = Video.create!(title: "Fishing Boat Docked By the Port", description: "Shipping Vessel Docks in Italian Port City", category: 'Education', channel_id: u17.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/industry/Fishing+Boat+At+Port.mp4
...
seed_vid_20 = Video.create!(title: "Hammer and Nail", description: "The Classic Tale of the Hammer and the Nail.", category: 'Education', channel_id: u17.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/industry/Hammer+Down+a+Nail.mp4
...
seed_vid_21 = Video.create!(title: "Manufacturing ASMR", description: "Stainless Steel Drill rotation at 4000 rpm", category: 'Education', channel_id: u17.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/industry/Manufacturing.mp4
...
seed_vid_22 = Video.create!(title: "Warm Light Bulb Glow", description: "Campfire night time light glowing effervescent red", category: 'Education', channel_id: u17.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/industry/Swinging+Light+Bulb.mp4
...
seed_vid_23 = Video.create!(title: "Vineyard Fields In Southern Spain", description: "The Andorra vineyards of Spain" , category: 'Education', channel_id: u17.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/industry/Vineyard+Production.mp4
...
seed_vid_24 = Video.create!(title: "Pipe Cutting ASMR", description: "Quiet, Relaxing, Meditative Pipe Cutting", category: 'Education', channel_id: u17.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/industry/cutting_pipe.mp4
...
seed_vid_25 = Video.create!(title: "Friday Day of Fun and Fair", description: "Wyoming Carnival Fun - August 2018", category: 'People and Blogs', channel_id: u18.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/lifestyle/Fun+Fair.mp4
...
seed_vid_26 = Video.create!(title: "Peaceful Beach Retreat at Lisbon Portugal", description: "The ships just docked on the Western city edge. The weather is sunny. The temperature is warm. Life is great", category: 'People and Blogs', channel_id: u18.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/lifestyle/People+Having+Fun+At+The+Beach.mp4
...
seed_vid_27 = Video.create!(title: "Mercedes", description: "Fast. Luxurious. Prestige. Mercedes.", category: 'People and Blogs', channel_id: u18.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/lifestyle/car_mercedes.mp4
...
seed_vid_28 = Video.create!(title: "Bird Eye View City Driving", description: "From the Sky's Outskirts, Eagles Flying Peering Down upon Land's Vicissitudes", category: 'People and Blogs', channel_id: u18.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/lifestyle/city_aerial.mp4
...
seed_vid_29 = Video.create!(title: "Bearded Man By Fire Thinks He's Jesus", description: "My friend Joe recently came back from a trip to the Tibetan temple. This ensued on my first time seeing him...", category: 'People and Blogs', channel_id: u18.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/lifestyle/fire_man.mp4
...
seed_vid_30 = Video.create!(title: "Flames", description: "The night is dark and full of terrors.", category: 'People and Blogs', channel_id: u18.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/lifestyle/fire_video.mp4
...
seed_vid_31 = Video.create!(title: "Volcano Row", description: "Full Body Intense HIIT calorie burning muscle building endorphin releasing cardio workout at Volcano Gym", category: 'People and Blogs', channel_id: u18.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/lifestyle/girl_working_out.mp4
...
seed_vid_32 = Video.create!(title: "Sunday Morning Delights", description: "I went out with my best friend Jen to this cute little cafe while we were in Belgium", category: 'People and Blogs', channel_id: u18.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/lifestyle/served_food.mp4
...
seed_vid_33 = Video.create!(title: "French Alps Ski Getaway", description: "Skiing on top of the world. #Blessed", category: 'People and Blogs', channel_id: u18.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/lifestyle/ski_resort.mp4
...
seed_vid_34 = Video.create!(title: "Nightlife TimeLaps", description: "The backstreets of Miami. Time standing still.", category: 'People and Blogs', channel_id: u18.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/lifestyle/timelapse.mp4
...
seed_vid_35 = Video.create!(title: "1001 Vegas Nights", description: "Sin City Christmas Lights. Gambling Drugs and More. Merry Christmas", category: 'People and Blogs', channel_id: u18.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/lifestyle/vegas_night.mp4
...
seed_vid_36 = Video.create!(title: "Side Sitting Sights", description: "Just another day. Just another life. Walking Past.", category: 'People and Blogs', channel_id: u18.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/lifestyle/walk_city.mp4
...
seed_vid_37 = Video.create!(title: "Cancun Ocean Waves", description: "Mexico vacation in Cancun. The Atlantic Ocean screaming in the backdrop", category: 'People and Blogs', channel_id: u18.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/lifestyle/woman_at_beach.mp4
...
seed_vid_38 = Video.create!(title: "Electro Drop Act - One", description: "Electro Drop House Music Part Life Night Time Club Music BreakDance Chill Relaxation", category: 'Music', channel_id: u19.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/music/electro_music1.mp4
...
seed_vid_39 = Video.create!(title: "Electro Drop Act - Two", description: "Electro Drop House Music Part Life Night Time Club Music BreakDance Chill Relaxation", category: 'Music', channel_id: u19.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/music/electro_music2.mp4
...
seed_vid_40 = Video.create!(title: "Electro Drop Act - Three", description: "Electro Drop House Music Part Life Night Time Club Music BreakDance Chill Relaxation", category: 'Music', channel_id: u19.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/music/electro_music3.mp4
...
seed_vid_41 = Video.create!(title: "Electro Drop Act - Four", description: "Electro Drop House Music Part Life Night Time Club Music BreakDance Chill Relaxation", category: 'Music', channel_id: u19.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/music/electro_music4.mp4
...
seed_vid_42 = Video.create!(title: "Electro Drop Act - Five", description: "Electro Drop House Music Part Life Night Time Club Music BreakDance Chill Relaxation", category: 'Music', channel_id: u19.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/music/electro_music5.mp4
...
seed_vid_43 = Video.create!(title: "3D Printer Printing Print", description: "Real time visualization of 3D product rendering", category: 'Science and Technology', channel_id: u20.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/tech/3D+Printer+Printing.mp4
...
seed_vid_44 = Video.create!(title: "3D Satellite Rendering Mockup", description: "NASA satellite product mockup for 3D rendering technology. Silicon wafers and test material for electrical circuitry", category: 'Science and Technology', channel_id: u20.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/tech/3D_satellite_mockup.mp4
...
seed_vid_45 = Video.create!(title: "Elevator Goes Up. Then It Goes Down.", description: "While (true) { Up. Down.}", category: 'Science and Technology', channel_id: u20.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/tech/Elevators+Going+Up+And+Down.mp4
...
seed_vid_46 = Video.create!(title: "New VR Release. Greatest Experience! Buy Now!", description: "Zuckerberg just released FB VR. Recent demo FB yearly presentation!", category: 'Science and Technology', channel_id: u20.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/tech/VR_demo.mp4
...
seed_vid_47 = Video.create!(title: "Apple. More Marketing. Buy.", description: "New IMac XTS demo release. Promotional video. 4k resolution. 256 GB RAM. 10 petabyte SSD.", category: 'Science and Technology', channel_id: u20.id) # https://s3-us-west-1.amazonaws.com/streamit-videos/tech/apple_presentation.mp4
